...
export class SimulatorXcode10 extends EventEmitter {
   ...
   * @param {import('@limrun/appium-xcode').XcodeVersion} xcodeVersion - The target Xcode version in format {major, minor, build}.
   * @param {import('@appium/types').AppiumLogger?} log
   * @param {string} limInstanceApiUrl - The URL of the Limrun instance API.
   * @param {string} limInstanceToken - The token of the Limrun instance.
   */
  constructor (udid, xcodeVersion, log = null, limInstanceApiUrl, limInstanceToken) {
    super();
  ...
  /**
   * @returns {import('@limrun/appium-xcode').XcodeVersion}
   */
  get xcodeVersion() {
